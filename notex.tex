...
\begin{enumerate}
    ...
    \item Dimostrare che $A\neq\emptyset$ e $A\neq\mathbb{N}$, ovvero che non sia un insieme banale.
...
\begin{figure}[H]
    ...
    \caption{Dato in ingresso un programma $P$, il programma $V$ mi dice se è corretto o errato}
\end{figure}
...
Consideriamo $PC$ come l'insieme dei \textbf{programmi corretti}, questo insieme può essere riconosciuto
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{images/classi_complessità.png}
